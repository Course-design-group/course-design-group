...
public class LaserLauncher extends Tool {
	...
	public LaserLauncher(int color) {
		...
		if (color == Color.RED) {
			...
			setImages(new int[] { R.drawable.green_launcher1,
					R.drawable.green_launcher2, R.drawable.green_launcher3,
					R.drawable.green_launcher4, R.drawable.green_launcher5,
					R.drawable.green_launcher6, R.drawable.green_launcher7,
					R.drawable.green_launcher8 });
		}
